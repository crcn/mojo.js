...
- Small core. Modules make up the rest. 
  ...
  - The framework itself is broken into multiple repositories - this makes it easier to encapsulate, and re-use bits of functionality. It also makes it easier for you to dive into the source code if you want to understand Mojo more deeply.
