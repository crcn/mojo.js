...
(function() {
  ...
  define(["jquery", "events", "bindable", "./collection", "../utils/idGenerator", "outcome", "dref", "underscore", "./decor/facade", "asyngleton", "../models/locator", "../utils/compose", "../utils/async", "pilot-block", "toarray"], function($, events, bindable, ViewCollection, generateId, outcome, dref, _, ViewDecorator, asyngleton, modelLocator, compose, async, pilot, toarray) {
    var BaseView;
    ...
    return BaseView = (function(_super) {
      ...
      */
      ...
      BaseView.prototype._onLoaded = function() {
        ...
        this._loading = false;
        if ((_ref = this._parent) != null ? _ref._loading : void 0) {
          return;
        }
      ...
      BaseView.prototype._onDisplay = function() {
        ...
        return this.section.replaceChildren(this._domElement);
      };

      BaseView.prototype._onDisplayed = function() {
        return this._displayed = true;
      };
      ...
      BaseView.prototype._onRemoved = function() {
        ...
        if ((_ref = this._parent) != null ? _ref._removing : void 0) {
          return;
        }
