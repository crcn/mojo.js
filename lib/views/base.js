    ...
    return BaseView = (function(_super) {
      ...
      */
      ...
      function BaseView(data) {
        ...
        this.init();
        this._listen();
        ViewDecoratorFactory.setup(this);
      }
