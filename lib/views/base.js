...
(function() {
  ...
  define(["jquery", "events", "bindable", "./collection", "../utils/idGenerator", "outcome", "dref", "underscore", "./decor/facade", "asyngleton", "../models/locator", "../utils/compose", "../utils/async", "toarray"], function($, events, bindable, ViewCollection, generateId, outcome, dref, _, ViewDecorator, asyngleton, modelLocator, compose, async, toarray) {
    var BaseView;
    ...
    return BaseView = (function(_super) {
      ...
      */
      ...
      function BaseView(options) {
        ...
        this._id = dref.get(options, "_id") || dref.get(options.item || {}, "_id") || generateId();
        options = _.extend({}, this.data || {}, options);
        options.view = this;
      ...
      */
      ...
      BaseView.prototype.parent = function() {
        var p;

        if (this._parent) {
          return this._parent;
        }
        p = this.el[0].parentNode;
        while (p) {
          if (p._view) {
            return p._view;
          }
      ...
      BaseView.prototype.attached = function() {
        var p;
        ...
        return p.parentNode === document.body;
      };
      ...
      */
      ...
      BaseView.prototype.root = function() {
        var p, pv;
