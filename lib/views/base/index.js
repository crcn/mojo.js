...
var DecorFactory, DecorableView, bindable, dref, flatstack, generateId, loaf, models, type, _,
...
DecorableView = (function(_super) {
  ...
  */
  ...
  DecorableView.prototype._call = function(startEvent, endEvent, next) {
    ...
    if (this._callInfo[endEvent]) {
      return next();
    }
    this.once(endEvent, next);
    if (this._callInfo[startEvent]) {
      return;
    }
    this._callInfo[startEvent] = true;
    this.emit(startEvent);
    this._onRemove();
    return this.callstack.push(function() {
      _this._callInfo[endEvent] = true;
  ...
  */
  ...
  DecorableView.prototype.linkChild = function() {
    var child, _i, _len;
