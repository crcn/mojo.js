...
var DecorableView, Inheritable, bindable, flatstack, generateId, loaf, structr, type, _,
...
DecorableView = (function(_super) {
  ...
  */
  ...
  DecorableView.prototype._init = function(event) {
    ...
    this.bind("_parent").to(this._onParent).now();
  ...
  */
  ...
  DecorableView.prototype._onSectionChange = function(key, value) {
    return console.log("SECT");
  };
  ...
  */
  ...
  DecorableView.prototype.setChild = function(name, child) {
    child.name = name;
    child.set("application", this.application);
    child.set("models", this.application.models);
