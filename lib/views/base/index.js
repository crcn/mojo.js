...
DecorableView = (function(_super) {
  ...
  */
  ...
  function DecorableView(data, application) {
    ...
    this.section = loaf((_ref6 = this.application) != null ? _ref6.nodeFactory : void 0);
    this.init();
  }
  ...
  */
  ...
  DecorableView.prototype.init = function() {
    ...
    return this.bind("applicaiton").to(this._onApplication).now();
  };
  ...
  */
  ...
  DecorableView.prototype._onApplication = function(application) {
    return this.section.nodeFactory = application.nodeFactory;
  };
