...
var AttributesDecorator, BaseViewDecorator, BindingsDecorator, DraggableDecorator, DroppableDecorator, EventsDecorator, PaperclipDecorator, PreloadDecorator, SectionsDecorator, SelectorDecorator, TransitionDecorator, availableDecorators, _decor;
...
availableDecorators = [_decor("bindings", BindingsDecorator), _decor("selector", SelectorDecorator), _decor("preload", PreloadDecorator), _decor("sections", SectionsDecorator), _decor("paperclip", PaperclipDecorator, false), _decor("attributes", AttributesDecorator), _decor("transition", TransitionDecorator), _decor("events", EventsDecorator), _decor("draggable", DraggableDecorator), _decor("droppable", DroppableDecorator)];
