    ...
    SingletonDecorator = (function(_super) {
      ...
      */
      ...
      SingletonDecorator.prototype.render = function(callback) {
        var i, inherit, p, pd, property, _i, _j, _len, _len1;

        this._bindings = [];
        p = this.view.parent();
        inherit = toarray(this.view.inherit);
        while (p) {
          if (p.passDown) {
            ...
            for (_i = 0, _len = pd.length; _i < _len; _i++) {
              ...
              this._bindings.push(p.bind(property).to(this.view, property).to(function(value) {
          ...
          for (_j = 0, _len1 = inherit.length; _j < _len1; _j++) {
            i = inherit[_j];
            p.bind(i).to(this.view, i).to(function(value) {
