    ...
    return (function(_super) {
      ...
      */
      ...
      function _Class(decorator, options) {
        ...
        this.states = new bindable.Collection();
        this.states.enforceId(false);
        this.states.reset((this.options.views || this.options).map(function(stateOptions) {
