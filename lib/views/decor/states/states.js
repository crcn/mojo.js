...
(function() {
  ...
  define(["./state", "bindable", "stepc", "pilot-block"], function(State, bindable, stepc, pilot) {
    return (function(_super) {
      ...
      */
      ...
      function _Class(decorator, options) {
        ...
        this._id = this.name = this.options._name;
        this.sectionName = this.options.section;
        this._section = pilot.createSection();
      ...
      */
      ...
      _Class.prototype.load = function(callback) {
        ...
        this.once("loadedState", function() {
          if (_this.sectionName === "html" && !_this.view.template) {
            _this.view.section.html(_this._section.html());
          } else {
            _this.view.set(_this.sectionName, _this._section.html());
          }
          return callback();
        });
      ...
      */
      ...
      _Class.prototype._setIndex = function(index) {
        var newStateView, oldView, self, state, _ref;
        ...
        return stepc.async((function() {
          return newStateView.load(this);
        }), (function() {
          if (!oldView) {
            return this();
          }
          return oldView.remove(this);
        }), (function(err) {
          if (err) {
            console.error(err);
          }
