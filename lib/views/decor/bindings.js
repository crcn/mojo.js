    ...
    rivets.configure({
      adapter: {
        ...
        read: function(obj, keypath) {
          return typeof obj.get === "function" ? obj.get(keypath.replace(/,/g, ".")) : void 0;
        },
        publish: function(obj, keypath, value) {
          return typeof obj.set === "function" ? obj.set(keypath.replace(/,/g, "."), value) : void 0;
        }
      }
    });
      ...
      */
      ...
      BindingsDecorator.prototype.render = function() {
        ...
        if (this.view.section.elements.length) {
          ...
          return rivets.bind(this.view.section.elements.filter(function(el) {
