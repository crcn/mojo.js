...
var State, StatesSection, ViewCollection, bindable, flatstack, loaf, states,
...
StatesSection = (function(_super) {
  ...
  StatesSection.prototype.__isLoader = true;
  ...
  */
  ...
  function StatesSection(view, name, options) {
    ...
    this.section = loaf();
    this.bind("currentName").to(this._setName).now();
  }
  ...
  */
  ...
  StatesSection.prototype._setName = function(name) {
    var i, state, _i, _len, _ref, _results;
    _ref = this.source.source();
    _results = [];
  ...
  */
  ...
  StatesSection.prototype._setIndex = function(index) {
    var isNew, newStateView, oldState, self, state, _ref, _ref1,
      _this = this;
    ...
    if ((_ref1 = this._displayListener) != null) {
      _ref1.dispose();
    }
