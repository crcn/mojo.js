...
var ListSection, ViewCollection, bindable, dref, factories, hoist, loaf, type,
...
ListSection = (function(_super) {
  ...
  ListSection.prototype.__isLoader = true;
  ...
  */
  ...
  ListSection.prototype.initList = function() {
    ...
    modelViewFactory = this.options.modelViewFactory || factories["class"](this.options.modelViewClass);
    ...
    this._modelTransformer = hoister.map(function(model) {
      ...
      ops = {};
      ops.model = model;
      ops._id = (_ref = model != null ? typeof model.get === "function" ? model.get("_id") : void 0 : void 0) != null ? _ref : model != null ? model._id : void 0;
      return ops;
