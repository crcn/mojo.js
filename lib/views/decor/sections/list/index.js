    ...
    ListSection = (function(_super) {
      ...
      */
      ...
      ListSection.prototype._fetchRemote = function(next) {
        ...
        console.log((_ref = this._sourceCollection) != null ? _ref.length() : void 0, this);
        if (!((_ref1 = this._sourceCollection) != null ? _ref1.fetch : void 0)) {
          return next();
        }
        return (_ref2 = this._sourceCollection) != null ? _ref2.fetch(next) : void 0;
      };
