    ...
    return ViewDecorator = (function(_super) {
      ...
      */
      ...
      ViewDecorator.prototype.load = function(callback) {
        ...
        return this._callDecorFn("load", false, callback);
      };
      ...
      */
      ...
      ViewDecorator.prototype.attach = function(callback) {
        ...
        return this._callDecorFn("attach", false, callback);
      };
      ...
      */
      ...
      ViewDecorator.prototype.remove = function(callback) {
        ...
        return this._callDecorFn("remove", true, callback);
      };
      ...
      */
      ...
      ViewDecorator.prototype._callDecorFn = cstep(function(name, reverse, callback) {
        var stack;

        stack = reverse ? this._decorArray.reverse() : this._decorArray;
        return async.eachSeries(stack, (function(decor, next) {
