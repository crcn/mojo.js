...
(function() {
  ...
  define(["underscore", "cstep", "../../utils/async", "../../factories/either", "../../factories/class", "../../utils/idGenerator", "outcome", "./base", "../collection", "../../utils/compose", "./template", "./children", "./listChildren", "./attributes", "./events", "./bindings", "./transition"], function(_, cstep, async, EitherFactory, ClassFactory, generateId, outcome, BaseViewDecorator, ViewCollection, compose, TemplateDecorator, ChildrenDecorator, ListChildrenDecorator, AttributesDecorator, EventsDecorator, BindingsDecorator, TransitionDecorator) {
