...
(function() {
  ...
  define(["underscore", "cstep", "../../utils/async", "../../factories/either", "../../factories/class", "../../utils/idGenerator", "outcome", "./base", "../collection", "../../utils/compose", "./template", "./children", "./listChildren", "./attributes", "./events", "./bindings", "./dragdrop/draggable", "./dragdrop/droppable", "./transition"], function(_, cstep, async, EitherFactory, ClassFactory, generateId, outcome, BaseViewDecorator, ViewCollection, compose, TemplateDecorator, ChildrenDecorator, ListChildrenDecorator, AttributesDecorator, EventsDecorator, DraggableDecorator, DroppableDecorator, BindingsDecorator, TransitionDecorator) {
    ...
    return ViewDecorator = (function(_super) {
      ...
      */
      ...
      ViewDecorator.prototype._addDecorators = function() {
        ...
        return this._facadeCollection.reset(decorators.sort(function(a, b) {
