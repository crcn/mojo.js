...
(function() {
  define(["underscore", "cstep", "../../factories/class", "../../utils/idGenerator", "./base", "../collection", "../../utils/compose", "./template", "./children", "./list/decorator", "./attributes", "./events", "./bindings", "./dragdrop/draggable", "./dragdrop/droppable", "./states/decorator", "./transition", "./preload"], function(_, cstep, ClassFactory, generateId, BaseViewDecorator, ViewCollection, compose, TemplateDecorator, ChildrenDecorator, ListDecorator, AttributesDecorator, EventsDecorator, BindingsDecorator, DraggableDecorator, DroppableDecorator, StatesDecorator, TransitionDecorator, PreloadDecorator) {
    ...
    */
    ...
    availableDecorators = [_decor("bindings", BindingsDecorator), _decor("list", ListDecorator), _decor("states", StatesDecorator), _decor("children", ChildrenDecorator), _decor("template", TemplateDecorator, false), _decor("preload", PreloadDecorator), _decor("attributes", AttributesDecorator), _decor("transition", TransitionDecorator), _decor("events", EventsDecorator), _decor("draggable", DraggableDecorator), _decor("droppable", DroppableDecorator)];
    return {
      /*
      */
