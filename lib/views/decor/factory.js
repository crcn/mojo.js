...
var AttributesDecorator, BaseViewDecorator, BindingsDecorator, DraggableDecorator, DroppableDecorator, EventsDecorator, PaperclipDecorator, PreloadDecorator, SectionsDecorator, TemplateDecorator, TransitionDecorator, ViewCollection, availableDecorators, _decor;
...
availableDecorators = [_decor("bindings", BindingsDecorator), _decor("sections", SectionsDecorator), _decor("template", TemplateDecorator, false), _decor("paperclip", PaperclipDecorator, false), _decor("preload", PreloadDecorator), _decor("attributes", AttributesDecorator), _decor("transition", TransitionDecorator), _decor("events", EventsDecorator), _decor("draggable", DraggableDecorator), _decor("droppable", DroppableDecorator)];
