  ...
  define(["bindable", "../utils/async", "cstep", "asyngleton", "outcome"], function(bindable, async, cstep, asyngleton, outcome) {
    ...
    return (function(_super) {
      ...
      */
      ...
      _Class.prototype.attach = function(callback) {
        var _this = this;

        return this.load(function() {
          return _this.render(function() {
            return _this.display(callback);
          });
        });
      };
      ...
      */
      ...
      _Class.prototype.render = asyngleton(function(callback) {
        return this._callViewMethod("render", "rendered", false, callback);
      });
      ...
      */
      ...
      _Class.prototype.display = asyngleton(function(callback) {
        return this._callViewMethod("display", "displayed", false, callback);
      });
      ...
      */
      ...
      _Class.prototype.remove = asyngleton(function(callback) {
        return this._callViewMethod("remove", "removed", true, callback);
      });
      ...
      */
      ...
      _Class.prototype._callViewMethod = function(method, event, reverse, callback) {
        ...
        return async.eachSeries(stack, (function(item, next) {
          var fn;
