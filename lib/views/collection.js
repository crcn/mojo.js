...
(function() {
  ...
  define(["bindable", "../utils/async", "cstep", "asyngleton", "../utils/throttleCallback"], function(bindable, async, cstep, asyngleton, throttleCallback) {
    ...
    return (function(_super) {
      ...
      function _Class() {
        this._displayLateItem = __bind(this._displayLateItem, this);        _ref = _Class.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      */
      ...
      _Class.prototype.emit = function() {
        ...
        return (_ref1 = this.view) != null ? _ref1.emit.apply(_ref1, arguments) : void 0;
      };
