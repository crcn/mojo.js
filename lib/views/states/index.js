  ...
  */
  ...
  StatesView = (function(_super) {
    ...
    function StatesView() {
      ...
      this._setIndexWithAnimation = __bind(this._setIndexWithAnimation, this);
    ...
    */
    ...
    StatesView.prototype._rebind = function() {
      ...
      this._indexBinding = this.bind("index", {
        to: process.browser ? this._setIndexWithAnimation : this._setIndex
      }).now();
      return this._cnameBinding = this.bind("currentName", {
        to: this._setName
      }).now();
    };
    ...
    */
    ...
    StatesView.prototype._setIndexWithAnimation = function() {
      return requestAnimationFrame(this._setIndex);
    };
    ...
    */
    ...
    StatesView.prototype._setIndex = function() {
      ...
      self = this;
      state = this.currentState = this.source.at(this.index || 0);
      isNew = !state.hasView();
