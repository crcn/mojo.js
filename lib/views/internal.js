...
(function() {
  ...
  define(["jquery", "../bindable/inheritable", "underscore", "./collection", "../utils/idGenerator", "dref", "../models/locator", "pilot-block", "./states", "type-component"], function($, BindableInheritableObject, _, ViewCollection, generateId, dref, modelLocator, pilot, ViewStates, type) {
    var InternalView;
    ...
    return InternalView = (function(_super) {
      ...
      */
      ...
      InternalView.prototype.decorate = function(options) {
