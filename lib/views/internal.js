...
(function() {
  ...
  define(["jquery", "../bindable/inheritable", "./collection", "../utils/idGenerator", "dref", "../models/locator", "pilot-block", "./states"], function($, BindableInheritableObject, ViewCollection, generateId, dref, modelLocator, pilot, ViewStates) {
    var InternalView;
