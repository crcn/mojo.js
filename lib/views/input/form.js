      ...
      */
      ...
      FormView.prototype._onRendered = function() {
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          inputView = _ref1[_i];
          _results.push((function(inputView) {
            console.log("model." + (inputView.get("name")));
            return _this.bind("model." + (inputView.get("name"))).to(inputView, "value").to(function(value) {
              return console.log(inputView.get("name"), value);
            });
          })(inputView));
        }
        return _results;
