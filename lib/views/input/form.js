...
(function() {
  ...
  define(["../index", "../../templates/factory", "mannequin"], function(BaseView, templates, mannequin) {
    /*
    */
    ...
    return FormView = (function(_super) {
      ...
      */
      ...
      FormView.prototype._onRendered = function() {
        var inputView, _i, _len, _ref1, _results;

        FormView.__super__._onRendered.call(this);
        this._validate();
        _ref1 = this.children.source();
        _results = [];
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          inputView = _ref1[_i];
          _results.push(this.bind("model." + (inputView.get("name"))).to(inputView, "value").to(this._validate).bothWays());
        }
        return _results;
      };
