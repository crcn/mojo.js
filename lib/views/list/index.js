...
var ListView, bindable, dref, factories, hoist, nofactor, type, _ref,
...
ListView = (function(_super) {
  ...
  */
  ...
  ListView.prototype._insertModelView = function(modelView) {
    this.linkChild(modelView);
    modelView.render();
    console.log("INS", this._rendered, this._modelViewClass.name);
    if (this._rendered) {
      return this._deferInsert(modelView.section.toFragment());
    } else {
      return this.section.append(modelView.section.toFragment());
    }
  };
  ...
  */
  ...
  ListView.prototype._insertDeferredSections = function() {
    console.log(this._deferredSections.length, "GG");
