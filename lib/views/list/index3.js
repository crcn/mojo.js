  ...
  */
  ...
  ListView = (function(_super) {
    ...
    function ListView() {
      ...
      this._onFilterChange = __bind(this._onFilterChange, this);
      this._onFilterOptionChange = __bind(this._onFilterOptionChange, this);
    ...
    */
    ...
    ListView.prototype._decorated = true;
    ...
    */
    ...
    ListView.prototype._render = function() {
      ...
      if ((_ref4 = this._filterBinding) != null) {
        _ref4.dispose();
      }
      ...
      this._filterBinding = this.bind("filter").to(this._onFilterOptionChange).now();
    ...
    */
    ...
    ListView.prototype._onFilterOptionChange = function(filter) {
      var _ref1;

      if ((_ref1 = this._filterOptionBinding) != null) {
        _ref1.dispose();
      }
      if (type(filter) === "string") {
        return this._filterOptionBinding = this.bind(filter).to(this._onFilterChange).now();
      } else {
        return this._onFilterChange(filter);
      }
    };
    ...
    */
    ...
    ListView.prototype._onFilterChange = function(filter) {
      this._filter = filter;
      if (!this._source) {
        return;
      }
      return this._refilter(this._source.source());
    };
    ...
    */
    ...
    ListView.prototype._refilter = function(models) {
      ...
      for (_i = 0, _len = models.length; _i < _len; _i++) {
        ...
        if (useModel) {
          _results.push(this._views.push(this._mapModel(model)));
        } else {
          _results.push(this._views.splice(modelIndex, 1));
        }
      }
      return _results;
    };
