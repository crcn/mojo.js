...
define(["require", "bindable", "modules/mojo/interm/views/adapters/backbone/model", "hoist", "asyngleton"], function(require) {

    var __dirname = "modules/mojo/interm/views/adapters/backbone",
    __filename    = "modules/mojo/interm/views/adapters/backbone/collection.js",
    module        = { exports: {} },
...
(function() {
  var BackboneWrapperCollection, BackboneWrapperModel, asyngleton, bindable, hoist,
  ...
  BackboneWrapperCollection = (function(_super) {
