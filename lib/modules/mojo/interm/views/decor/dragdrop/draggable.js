...
define(["require", "modules/mojo/interm/views/decor/base", "modules/mojo/interm/views/decor/dragdrop/collection", "underscore"], function(require) {

    var __dirname = "modules/mojo/interm/views/decor/dragdrop",
    __filename    = "modules/mojo/interm/views/decor/dragdrop/draggable.js",
    module        = { exports: {} },
...
(function() {
  var BaseViewDecorator, DraggableDecorator, droppables, _, _ref,
  ...
  DraggableDecorator = (function(_super) {
    ...
    */
    ...
    DraggableDecorator.prototype.display = function() {
    ...
    */
    ...
    DraggableDecorator.prototype._initListeners = function() {
      ...
      el.bind("mousedown", this._startDrag);
      return el.bind("dragstart", function() {});
    };
    ...
    */
    ...
    DraggableDecorator.prototype._startDrag = function(e) {
      ...
      this.draggedItem = this.document.find("body").append(el.html()).children().last();
