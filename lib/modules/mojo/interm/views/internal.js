...
define(["require", "modules/mojo/interm/bindable/inheritable", "underscore", "modules/mojo/interm/views/collection", "modules/mojo/interm/utils/idGenerator", "dref", "modules/mojo/interm/models/locator", "pilot-block", "modules/mojo/interm/views/states", "type-component"], function(require) {

    var __dirname = "modules/mojo/interm/views",
    __filename    = "modules/mojo/interm/views/internal.js",
    module        = { exports: {} },
...
(function() {
  ...
  BindableInheritableObject = require("modules/mojo/interm/bindable/inheritable");

  _ = require("underscore");

  ViewCollection = require("modules/mojo/interm/views/collection");

  generateId = require("modules/mojo/interm/utils/idGenerator");

  dref = require("dref");

  modelLocator = require("modules/mojo/interm/models/locator");

  pilot = require("pilot-block");

  ViewStates = require("modules/mojo/interm/views/states");
