      ...
      */
      ...
      Mediator.prototype._register = function(routes, callback) {
        ...
        for (_i = 0, _len = routes.length; _i < _len; _i++) {
          ...
          if (route.type === "pre") {
            _results.push(hooks.pre.call(this.commands, name, callback));
          } else if (route.type === "post") {
            _results.push(hooks.post.call(this.commands, name, callback));
          } else if (!route.type) {
            _results.push(hooks.hook.call(this.commands, name, callback));
          } else {
