define(["require", "bindable/lib/object/dref", "dref", "bindable/lib/shim/dref", "bindable/lib/core/eventEmitter", "bindable/lib/object/binding", "bindable/lib/core/builder"], function(require) {

    var __dirname = "bindable/lib/object",
    __filename    = "bindable/lib/object/index.js",
    module        = { exports: {} },
...
(function() {
  ...
  dref = require("bindable/lib/object/dref");

  require("dref").use(require("bindable/lib/shim/dref"));

  EventEmitter = require("bindable/lib/core/eventEmitter");

  Binding = require("bindable/lib/object/binding");

  Builder = require("bindable/lib/core/builder");
